...
const Advocacy = () => {
  ...
  return (
    ...
    <div className='Advocacy_heading_one' data-aos="zoom-in" ><h2>RAISING AWARENESS</h2></div>
      <div className='advocacy_headings' data-aos="zoom-in">
        <h3>ADVOCACY</h3>
    ...
    <div className='advocacy_paragraph' data-aos="fade-up" data-aos-delay="200"><h2>Advocacy for a Better Africa</h2>
