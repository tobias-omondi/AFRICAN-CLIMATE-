...
import Podcast from './components/Multimedia/Podcast';
import Interview from './components/Multimedia/Interview';
import Documentaries from './components/Multimedia/Documentaries';
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/multimedia/interview' element={< Interview/>} />
        <Route path='/multimedia/documentary' element={< Documentaries/>} />
